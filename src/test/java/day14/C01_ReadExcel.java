...
public class C01_ReadExcel {
    ...
    public void readExelTest1() throws IOException {
        ...
        Workbook workbook = WorkbookFactory.create(fis);//Workbook objesi ile fis objesi akisa aldigimiz dosyamiza bir exel dosyasi create ettik.

        //- Sheet objesi olusturun workbook.getSheetAt(index)
        Sheet sheet = workbook.getSheet("Sayfa1");//Exel dosyamizda calismak istedigimiz sayfayi bu sekilde seceriz.
