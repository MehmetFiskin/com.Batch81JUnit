...
public class C04_FileExist {
    ...
    public void test1() {
        ...
        System.out.println(System.getProperty("user.dir"));///Users/mehmetfiskin/Desktop/Tum derslerim/com.Batch81JUnit
        //Şuanki içinde bulunduğum yolu gösterir
        System.out.println(System.getProperty("user.home"));///Users/mehmetfiskin
 ...
 */
        String dosyaYolu = "/Users/mehmetfiskin/Downloads/text.txt";
        //System.out.println(Files.exists(Paths.get(dosyaYolu)));
        Assert.assertTrue(Files.exists(Paths.get(dosyaYolu)));
        /*
